<template>
    <li class="mb-2">
        <a v-if="source['comment_id']" class="dropdown-item border-radius-md" :class="[real_viewed == 0 ? 'notview' : 'viewed']" @click="gocomment">
...
export default {
    ...
    methods: {
        ...
        govideo() {
            ...
            dropdownMenu.classList.remove('show');
            this.$router.push({
                name: 'Video', params: { post_id: this.source['post_id'], }
            });
        }
    }
}
